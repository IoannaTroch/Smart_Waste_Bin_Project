...
- [x] **Milestone 5 (Lab 05):** Model your Smart Waste Bin system using JSON-LD. Describe your sensors, the wastebin, and the deployment environment as structured entities with explicit relationships between them.
